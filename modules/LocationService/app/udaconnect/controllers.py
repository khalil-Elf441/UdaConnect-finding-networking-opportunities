...
@api.route("/locations/<person_id>/daterange")
...
class LocationResource(Resource):
    ...
    def get(self, person_id) -> List[Location]:
        ...
        locations: List[Location] = LocationService.retrieve_person_datediff(person_id=person_id, start_date=start_date, end_date=end_date)
        return locations
